...
public class MailUtils {
	public static void main(String[] args) throws AddressException, MessagingException {
		MailUtils.sendMail("markfang@live.com", "title","content");
	}
	...
	public static void sendMail(String email, String title, String emailMsg)
		  ...
		  Properties props = new Properties();
		    props.put("mail.smtp.user","Mark's");
		   ...
		   // SecurityManager security = System.getSecurityManager();
		    ...
		    try{
		        ...
		        msg.setFrom(new InternetAddress("Mark's"));
 ...
 class SMTPAuthenticator extends javax.mail.Authenticator{
    public PasswordAuthentication getPasswordAuthentication(){
        return new PasswordAuthentication("fangxianzheng1234@gmail.com", "xyCEO9Qeq");
    }
}
